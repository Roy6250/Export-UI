export const Footer = () => {
  return (
    <footer
      id="contact"
      className=" bg-gradient-to-b from-green-200 to-green-100 text-gray-800 py-10"
    >
      <div className=" mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 border-b border-t border-gray-300 py-6">
          {/* Company Info */}
          <div>
            <h2 className="text-2xl font-bold text-green-700">
              Tradeology <span className="text-gray-800">Exim Solutions LLP</span>
            </h2>
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2 text-sm">
              ...
              <li>
                <a href="/policy" className="hover:text-green-700 transition">
                  Policy
                </a>
              </li>
              <li>
